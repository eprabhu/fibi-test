...
BEGIN
        ...
        DECLARE LS_CLAIM_TITLE VARCHAR(300);
        ...
        DECLARE LS_CLAIM_AMOUNT DECIMAL(12,2);
		DECLARE LS_CLAIM_PREPARER VARCHAR(200);
        DECLARE LS_CREATE_USER VARCHAR(200);
        DECLARE LS_ORIGINAL_APPROVED_BUDGET DECIMAL(12,2);
        DECLARE LS_LATEST_APPROVED_BUDGET DECIMAL(12,2);
        DECLARE LS_BANK_CLEARANCE_DATE DATETIME;
        DECLARE LS_INVOICE_NUMBER VARCHAR(100);
        DECLARE LS_INVOICE_DATE DATETIME;
        DECLARE LS_CUM_CLAIM_AMOUNT_TO_DATE DECIMAL(12,2);
        DECLARE LS_TOTAL_CUM_CLAIM_AMOUNT_UPTO_CLAIM DECIMAL(12,2);
        ...
        DECLARE LS_BASIS_OF_CLAIM_SUBMISSION_DATE DECIMAL(12,2);
        DECLARE LS_BASIS_OF_CLAIM_INVOICE_DATE  DECIMAL(12,2);
        DECLARE LS_INVOICE_AMOUNT DECIMAL(12,2);
        DECLARE LS_ACTUAL_REVENUE DECIMAL(12,2);
        DECLARE LS_ACTUAL_EXPENSE DECIMAL(12,2);
