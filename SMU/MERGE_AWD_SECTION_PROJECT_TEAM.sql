...
DECLARE LS_DOCUMENT_UPDATE_TIMESTAMP	DATETIME;
	BEGIN
			...
			BEGIN
				...
				VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_SECTION_PROJECT_TEAM',LS_TABLE_NAME,105,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
				COMMIT;
			END;
            ...
            BEGIN
				...
				END IF;
				SELECT IFNULL(MAX(AWARD_PROJECT_TEAM_ID),0)+1 INTO LI_PROJECT_TEAM_NEXT_VAL FROM AWARD_PROJECT_TEAM;
