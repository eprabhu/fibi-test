DELIMITER $$
CREATE  FUNCTION `FN_FEED_INST_PROPOSAL_bkp`(
...
WHERE T1.PROPOSAL_ID = AV_DEV_PROPOSAL_ID;
 BEGIN
    ...
    INSERT_LOOP: LOOP
		FETCH CUR_PROPOSAL_PERSONS INTO LI_PROPOSAL_PERSON_ID,LS_PERSON_ID,LI_ROLODEX_ID,LS_FULL_NAME,LS_PROP_PERSON_ROLE_CODE,LI_PERCENTAGE_OF_EFFORT,LS_EMAIL_ADDRESS;
        IF DONE  THEN
				LEAVE INSERT_LOOP;
		END IF;
