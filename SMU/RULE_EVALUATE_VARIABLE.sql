...
SELECT T1.LVALUE,
    ...
    SELECT T1.TABLE_NAME,T1.COLUMN_NAME,T1.MODULE_CODE,T1.SUB_MODULE_CODE
    INTO LS_TABLE_NAME,LS_COLUMN_NAME,AV_MODULE_CODE,AV_SUBMODULE_CODE
    ...
    ELSEIF AV_MODULE_CODE = 12 AND AV_SUBMODULE_CODE = 0 THEN
    ...
    END IF;
     IF AV_MODULE_CODE IN (1,2,3,5,12) AND AV_SUBMODULE_CODE IN (0,4,1,2) THEN
        IF LS_OPERATOR = '%' THEN
