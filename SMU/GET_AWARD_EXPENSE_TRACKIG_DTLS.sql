...
IF AV_ACTUAL_COMMITED_FLAG = 'A' THEN
								IF AV_INTERNAL_ORDER_CODE IS NOT NULL THEN
									IF LOCATE('UNASSIGNED',AV_INTERNAL_ORDER_CODE) THEN
											SELECT * FROM (SELECT
													...
													AWARD_EXPENSE_TRANS_ID,FUND_CENTER,ASSET_INTERNAL_ORDER,
													REMARKS,ASSET,TRANSACTION_CURRENCY,GL_DESCRIPTION,
													...
													PREDECESSOR_DOC_NUMBER,REFERENCE_DOC_NUMBER,VENDOR_CODE,VENDOR_NAME,
										...
										AND T7.IO_CODE IS NOT NULL
											...
											ORDER BY TAB.FM_POSTING_DATE DESC;
									ELSE
										SELECT
												AWARD_NUMBER,ACCOUNT_NUMBER,INTERNAL_ORDER_CODE,
												BANK_CLEARING_DATE,
						...
						IF AV_FILTER_TYPE  = 'Y' THEN
													IF AV_INTERNAL_ORDER_CODE IS NOT NULL THEN
																...
																AND (CASE WHEN (AV_FM_POSTING_START_DATE) IS NOT NULL  AND (AV_FM_POSTING_END_DATE)  IS NOT NULL
																	...
																	THEN 0 = 0
																END)
																AND T1.AWARD_EXPENSE_TRANS_ID  IN (SELECT AWARD_EXPENSE_TRANS_ID
																									FROM AWARD_EXPENSE_TRANSACTIONS WHERE (DOCUMENT_NUMBER,ITEM_NUMBER,REFERENCE_DOCUMENT_CATEGORY,REFERENCE_ORG_UNIT,ACCT_ASSIGNMENT_NUMBER,SCHEDULE_LINE_NUMBER,
																																			CONDITION_COUNTER,REFERENCE_PROCEDURE,DOCUMENT_NUMBER_FM_LINE_ITEM,TRANSACTION_NUMBER) IN
																																		(SELECT DOCUMENT_NUMBER,ITEM_NUMBER,REFERENCE_DOCUMENT_CATEGORY,REFERENCE_ORG_UNIT,ACCT_ASSIGNMENT_NUMBER,SCHEDULE_LINE_NUMBER,
																																		CONDITION_COUNTER,REFERENCE_PROCEDURE,DOCUMENT_NUMBER_FM_LINE_ITEM,TRANSACTION_NUMBER
																																		FROM expense_zero_exclude_commit_v))
																ORDER BY T1.FM_POSTING_DATE DESC;
													ELSE
																SELECT
																		AWARD_NUMBER,ACCOUNT_NUMBER,INTERNAL_ORDER_CODE,
						...
						ELSE
													IF AV_INTERNAL_ORDER_CODE IS NOT NULL THEN
														IF LOCATE('UNASSIGNED',AV_INTERNAL_ORDER_CODE) THEN
                                                                ...
                                                                SELECT
																				AWARD_NUMBER,ACCOUNT_NUMBER,INTERNAL_ORDER_CODE,
																				NULL AS BANK_CLEARING_DATE,
																				NULL AS FM_POSTING_DATE,
																				NULL AS FI_POSTING_DATE,
																				NULL AS UPDATE_TIMESTAMP,
																				NULL AS DOCUMENT_DATE,
																				NULL AS PO_DATE,NULL AS VENDOR_CLEARING_DATE,COMMITTED_AMOUNT AS AMOUNT_IN_FMA_CURRENCY,NULL AS TC_AMOUNT,
																				NULL AS AWARD_EXPENSE_TRANS_ID,NULL AS FUND_CENTER,NULL AS ASSET_INTERNAL_ORDER,
																				NULL AS REMARKS,NULL AS ASSET,NULL AS TRANSACTION_CURRENCY,NULL AS GL_DESCRIPTION,
																				NULL AS COMMITMENT_ITEM,NULL AS ASSET_LOCATION,NULL AS FM_DOC_NUMBER,NULL AS INVOICE_NUMBER,NULL AS ACTUAL_OR_COMMITTED_FLAG,
																				NULL AS ASSET_COST_CENTER,NULL AS ASSET_LOCATION_CODE,NULL AS FI_GL_ACCOUNT,NULL AS FI_GL_DESCRIPTION,NULL AS FI_PO_COST_CENTRE,
																				NULL AS PO_GL_ACCOUNT,NULL AS PO_GL_DESCRIPTION,NULL AS PO_NUMBER,NULL AS PREDECESSOR_DOC_CAT,NULL AS PREDECESSOR_DOC_CAT_TEXT,
																				NULL AS PREDECESSOR_DOC_ITEM,NULL AS PREDECESSOR_DOC_ITEM_ACCOUNT,NULL AS PREDECESSOR_DOC_ITEM_ORG_UNIT,
																				NULL AS PREDECESSOR_DOC_NUMBER,NULL AS REFERENCE_DOC_NUMBER,NULL AS VENDOR_CODE,NULL AS VENDOR_NAME,
																				NULL AS UPDATE_USER,NULL AS PR_DATE,NULL AS GR_DATE,NULL AS INVOICE_DATE, NULL AS REQUESTER_NAME,NULL AS TRANSACTION_REFERENCE_NUMBER,NULL AS DOCUMENT_NUMBER,
																				IS_FROM_SAP,NULL AS PO_PR_FLAG
																		FROM AWARD_EXPENSE_DETAILS_EXT T1
																		WHERE T1.ACCOUNT_NUMBER = AV_ACCOUNT_NUMBER
																		AND INTERNAL_ORDER_CODE IS NULL
																		AND IS_FROM_SAP = 'N'
																		AND T1.COMMITTED_AMOUNT <> 0.00) TAB
																ORDER BY TAB.FM_POSTING_DATE DESC;
													ELSE
																	SELECT * FROM
                                                                    (SELECT
