DELIMITER $$
CREATE  PROCEDURE `MERGE_AWD_MASTER_BUDGET`(
...
DECLARE LI_AWD_BUDGT_CAL_AMT_NEXT_VAL		BIGINT(20);
DECLARE LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL	BIGINT(20);
DECLARE LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL		BIGINT(20);
DECLARE LI_AWD_BUDGT_RATE_BASE_NEXT_VAL		BIGINT(20);
...
DECLARE LI_AWD_RATE_ID_NEXT_VAL		BIGINT(20);
...
DECLARE LI_AWAD_BUDGET_PERSON_ID_CNT			INT(10);
...
SET LS_COUNT =0;
			BEGIN
				...
				BEGIN
					...
					VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_MASTER_BUDGET',LS_TABLE_NAME,102,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
					COMMIT;
				END;
				...
				IF LI_FLAG > 0 THEN
					...
					AND SEQUENCE_NUMBER = 0;
				END IF;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_CAL_AMT_NEXT_VAL
				FROM AWARD_BUDGET_DETAIL_CAL_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL
				FROM BUDGET_NON_PERSON_DTL_ID_GENERATOR
				WHERE NEXT_VAL IN (SELECT MAX(NEXT_VAL) FROM BUDGET_NON_PERSON_DTL_ID_GENERATOR);
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL
				FROM AWARD_BUDGET_PERSON_DETAIL_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_RATE_BASE_NEXT_VAL
				FROM AWARD_BUDGET_RATE_BASE_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_DETL_ID_NEXT_VAL
				FROM AWARD_BUDGET_DETAIL_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_PERIOD_NEXT_VAL
				FROM AWARD_BUDGET_PERIOD_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BUDGT_HEADER_NEXT_VAL
				FROM AWARD_BUDGET_HEADER_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_RATE_ID_NEXT_VAL
				FROM AWARD_BUDGET_RATE_ID_GENERATOR;
				SELECT IFNULL(MAX(NEXT_VAL),0) INTO LI_AWD_BGT_PERSN_ID_NEXT_VAL
				FROM AWARD_BUDGET_PERSON_ID_GENERATOR;
				...
				SELECT COUNT(1) INTO LI_AWAD_BUDGET_PERSON_ID_CNT
				FROM AWARD_BUDGET_PERSONS
				WHERE BUDGET_HEADER_ID IN(SELECT BUDGET_HEADER_ID FROM AWARD_BUDGET_HEADER WHERE AWARD_ID = AV_AWARD_ID);
				SELECT COUNT(1) INTO LI_AWD_BUDGT_HEADER_CNT FROM AWARD_BUDGET_HEADER
				WHERE AWARD_ID = AV_AWARD_ID;
				UPDATE AWARD_BUDGET_DETAIL_CAL_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_CAL_AMT_NEXT_VAL + LI_AWD_BUDGT_CAL_AMT_CNT + 1;
				UPDATE BUDGET_NON_PERSON_DTL_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL + LI_AWD_BUDGT_NON_PERSN_DTL_CNT + 1;
				UPDATE AWARD_BUDGET_PERSON_DETAIL_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL + LI_AWD_BUDGT_PERSN_DTL_CNT + 1;
				UPDATE AWARD_BUDGET_RATE_BASE_ID_GENERATOR
				SET NEXT_VAL =  LI_AWD_BUDGT_RATE_BASE_NEXT_VAL + LI_AWD_BUDGT_RATE_BASE_CNT + 1;
				UPDATE AWARD_BUDGET_DETAIL_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_DETL_ID_NEXT_VAL + LI_AWD_BUDGT_DETL_ID_CNT + 1;
				UPDATE AWARD_BUDGET_PERIOD_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_PERIOD_NEXT_VAL + LI_AWD_BUDGT_PERIOD_CNT + 1;
				UPDATE AWARD_BUDGET_RATE_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_RATE_ID_NEXT_VAL + LI_AWAD_RATE_ID_CNT + 1;
				UPDATE AWARD_BUDGET_HEADER_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BUDGT_HEADER_NEXT_VAL + LI_AWD_BUDGT_HEADER_CNT + 1;
				UPDATE AWARD_BUDGET_PERSON_ID_GENERATOR
				SET NEXT_VAL = LI_AWD_BGT_PERSN_ID_NEXT_VAL + LI_AWAD_BUDGET_PERSON_ID_CNT + 1;
				...
				BEGIN
					...
					END IF;
					SET LI_AWD_BUDGT_HEADER_NEXT_VAL = LI_AWD_BUDGT_HEADER_NEXT_VAL + 1;
					...
					BEGIN
						...
						END IF;
						SET LI_AWD_BUDGT_PERIOD_NEXT_VAL = LI_AWD_BUDGT_PERIOD_NEXT_VAL + 1;
					...
					BEGIN
						...
						END IF;
						SET LI_AWD_BUDGT_DETL_ID_NEXT_VAL = LI_AWD_BUDGT_DETL_ID_NEXT_VAL + 1;
						...
						BEGIN
							...
							END IF;
							SET LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL = LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL + 1;
							...
							VALUES
							(
							LI_AWD_BUDGT_PERSN_DTL_NEXT_VAL,
							LI_AWD_BUDGT_DETL_ID_NEXT_VAL,
							LS_PERSON_NAME,
							LS_PERSON_TYPE,
							LS_PERSON_ID,
						...
						BEGIN
							...
							END IF;
							SET LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL = LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL + 1;
							INSERT INTO AWARD_BUDGET_NON_PERSON_DETAIL
							(
							BUDGET_NON_PERSON_DTL_ID,
							BUDGET_DETAILS_ID,
							LINE_ITEM_NUMBER,
							DESCRIPTION,
							INTERNAL_ORDER_CODE,
							...
							VALUES
							(
							LI_AWD_BUDGT_NON_PERSN_DTL_NEXT_VAL,
							LI_AWD_BUDGT_DETL_ID_NEXT_VAL,
							LI_LINE_ITEM_NUMBER,
							LS_DESCRIPTION,
							LS_INTERNAL_ORDER_CODE,
						...
						BEGIN
							...
							END IF;
							SET LI_AWD_BUDGT_CAL_AMT_NEXT_VAL = LI_AWD_BUDGT_CAL_AMT_NEXT_VAL + 1;
					...
					BEGIN
						...
						END IF;
						SET LI_AWD_RATE_ID_NEXT_VAL = LI_AWD_RATE_ID_NEXT_VAL + 1;
					...
					BEGIN
						...
						END IF;
						SET LI_AWD_BGT_PERSN_ID_NEXT_VAL = LI_AWD_BGT_PERSN_ID_NEXT_VAL + 1;
						...
						,PERSON_NAME,NON_EMPLOYEE_FLAG,SALARY_ANNIVERSARY_DATE,PERSON_TYPE,UPDATE_TIMESTAMP,UPDATE_USER,
						BUDGET_HEADER_ID,BUDGET_PERSON_ID
						)
						VALUES(
						LS_APPOINTMENT_TYPE_CODE,
						LS_TBN_ID,
