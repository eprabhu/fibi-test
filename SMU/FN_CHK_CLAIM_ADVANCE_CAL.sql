DELIMITER $$
CREATE  FUNCTION `FN_CHK_CLAIM_ADVANCE_CAL`(AV_CLAIM_ID VARCHAR(6)) RETURNS varchar(10) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
DECLARE LI_COUNT INT(3);
DECLARE LI_CUM_CLAIM_AMOUNT_UPTO_CLAIM DECIMAL(12,0);
DECLARE LI_AMOUNT_REQ_CURRENT_CLAIM DECIMAL(12,0);
DECLARE LI_EXP_FORECAST DECIMAL(12,0);
DECLARE LI_AMOUNT_REQ DECIMAL(12,0);
DECLARE LS_BUDGET_CAT_CODE VARCHAR(3);
DECLARE LI_LATEST_BUD_AMNT DECIMAL(12,0);
DECLARE LI_PREV_CLAIM_AMT DECIMAL(12,0);
SET LI_COUNT =  0;
BEGIN
