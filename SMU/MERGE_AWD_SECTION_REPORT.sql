...
DECLARE LI_AWARD_RPT_TRCK_FILE_CNT		INT(10);
	BEGIN
			...
			BEGIN
				...
				VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_SECTION_REPORT',LS_TABLE_NAME,109,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
				COMMIT;
			END;
            ...
            BEGIN
				...
				END IF;
				SELECT IFNULL(MAX(AWARD_REPORT_TERMS_ID),0)+1 INTO LI_AWARD_REPORT_TERM_NEXT_VAL FROM AWARD_REPORT_TERMS;
				...
				END IF;
				SELECT IFNULL(MAX(AWARD_REPORT_TERM_RECIPIENT_ID),0)+1 INTO LI_AWARD_REPT_TERM_RECPT_NEXT_VAL FROM AWARD_REPORT_TERM_RECIPIENT;
				...
				END IF;
				SELECT IFNULL(MAX(AWARD_REPORT_TRACKING_ID),0)+1 INTO LI_AWD_REPT_TRACK_NEXT_VAL FROM AWARD_REPORT_TRACKING;
				...
				BEGIN
					...
					END IF;
					SELECT IFNULL(MAX(AWARD_REPORT_TRACKING_FILE_ID),0)+1 INTO LI_AWARD_RPT_TRCK_FILE_NEXT_VAL FROM AWARD_REPORT_TRACKING_FILE;
