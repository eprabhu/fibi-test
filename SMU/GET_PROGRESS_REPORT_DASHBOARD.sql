...
IF AV_TAB_TYPE = 'PENDING_PR' THEN
  ...
  ELSEIF AV_TAB_TYPE = 'COMPLETED_PR' THEN
	...
	ELSEIF AV_TAB_TYPE = 'AWARD_QUALIFIED' THEN
					...
					AND T1.AWARD_NUMBER NOT IN (SELECT AWARD_NUMBER FROM AWARD_PROGRESS_REPORT WHERE PROGRESS_REPORT_STATUS_CODE <>''4'') AND
					((T1.LEAD_UNIT_NUMBER IN(SELECT DISTINCT UNIT_NUMBER FROM PERSON_ROLE_RT WHERE RIGHT_NAME
