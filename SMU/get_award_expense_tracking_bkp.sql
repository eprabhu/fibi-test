DELIMITER $$
CREATE  PROCEDURE `get_award_expense_tracking_bkp`(
...
WHERE
T1.ACCOUNT_NUMBER = AV_ACCOUNT_NUMBER and
...
AND T2.SEQUENCE_NUMBER IN(SELECT MAX(T4.SEQUENCE_NUMBER) FROM AWARD_BUDGET_HEADER T4
