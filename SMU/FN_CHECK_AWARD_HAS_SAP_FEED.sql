...
AV_AWARD_ID	INT) RETURNS varchar(10) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
...
DECLARE LI_PREV_VERSION_NUMBER				INT(3);
		...
		BEGIN
			...
			VALUES(LI_SEQ_ERROR_LOG_ID,NULL,LI_FEED_ID,CONCAT('IN FN_CHECK_AWARD_HAS_SAP_FEED ',LS_ERROR_MSG),UTC_TIMESTAMP(),LS_UPDATE_USER);
		END;
		SELECT
			GRANT_CURRENCY,
			FUNDED_PROGRAM_TYPE,
