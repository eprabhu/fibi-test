...
BEGIN
    ...
    WHERE T1.PERSON_ID = AV_PERSON_ID
    AND T1.RIGHT_NAME IN ('VIEW_SAP_FEED', 'CREATE_PROPOSAL','MAINTAIN_EXTERNAL_USER','MAINTAIN_INTERFACE_PROCESSING', 'MAINTAIN_MANPOWER_FEED','MAINTAIN_INVOICE_FEED','VIEW_INVOICE_FEED','MAINTAIN_INVOICE_INTERFACE_PROCESSING');
END
$$
DELIMITER ;
