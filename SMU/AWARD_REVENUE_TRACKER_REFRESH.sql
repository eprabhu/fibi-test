...
DECLARE LI_AMOUNT_IN_FMA_CURRENCY                                 DECIMAL(12,2);
...
BEGIN
        ...
        BEGIN
                ...
                VALUES(LI_SEQ_ERROR_LOG_ID,LS_ACCOUNT_NUMBER,LS_INTERNAL_ORDER_CODE,LS_ERROR_MSG,'AWARD_REVENUE_TRACKER_REFRESH',UTC_TIMESTAMP(),'quickstart');
                COMMIT;
                SET LI_ERROR_FLAG = 1;
        END;
        SET LI_ERROR_FLAG = 0;
