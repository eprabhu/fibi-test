DELIMITER $$
CREATE  FUNCTION `MIGRATION_FN_FEED_INST_PROPOSAL`(
...
IFNULL(T1.ACTIVITY_TYPE_CODE,1),T1.START_DATE,T1.END_DATE,NULL,1,NOW(),AV_UPDATE_USER,T1.INTERNAL_DEADLINE_DATE,
