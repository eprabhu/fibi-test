...
DECLARE LS_DOCUMENT_UPDATE_TIMESTAMP	DATETIME;
	BEGIN
			...
			BEGIN
				...
				VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_SECTION_AWARD_KPI',LS_TABLE_NAME,122,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
				COMMIT;
			END;
            ...
            BEGIN
				...
				END IF;
				SELECT IFNULL(MAX(AWARD_KPI_ID),0)+ 1 INTO LI_AWARD_KPI_NEXT_VAL FROM AWARD_KPI;
				...
				BEGIN
					...
					END IF;
					SELECT IFNULL(MAX(AWARD_KPI_CRITERIA_ID),0)+ 1 INTO LI_AWARD_KPI_CRIT_NEXT_VAL FROM AWARD_KPI_CRITERIA;
