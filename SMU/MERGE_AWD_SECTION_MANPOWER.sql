...
DECLARE LI_UPD_AWARD_MANPOWER_ID INT(12);
	BEGIN
			...
			set sql_safe_updates = 0;
				...
				VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_SECTION_MANPOWER',LS_TABLE_NAME,131,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
				COMMIT;
			END;
			SELECT
    COUNT(1)
        ...
        AND SEQUENCE_NUMBER = 0;
            ...
            BEGIN
				...
				END IF;
						...
						FROM  AWARD_MANPOWER WHERE  AWARD_MANPOWER_ID = LI_AWARD_MANPOWER_ID;
						SELECT  COUNT(1) INTO LI_AWD_MANPW_RES_CNT
						FROM AWARD_MANPOWER_RESOURCE WHERE AWARD_MANPOWER_ID = LI_AWARD_MANPOWER_ID;
					    ...
					    ELSE
								...
								APPROVED_HEADCOUNT = LI_APPROVED_HEADCOUNT,
								...
								where BUDGET_REFERENCE_NUMBER = LS_BUDGET_REFERENCE_NUMBER
                                AND AWARD_ID = LI_MASTER_AWARD_ID;
								SELECT AWARD_MANPOWER_ID INTO LI_UPD_AWARD_MANPOWER_ID
								FROM AWARD_MANPOWER
								WHERE BUDGET_REFERENCE_NUMBER = LS_BUDGET_REFERENCE_NUMBER
                                AND AWARD_ID = LI_MASTER_AWARD_ID;
						END IF;
						SET LS_TABLE_NAME = 'AWARD_MANPOWER_RESOURCE';
						 BEGIN
							...
							SELECT
								...
								CHARGE_START_DATE, CHARGE_END_DATE, CHARGE_DURATION, COMMITTED_COST, RESOURCE_TYPE_CODE, DESCRIPTION, POSITION_OWNED_BY_AWARD,
								CANDIDATE_TITLE_TYPE_CODE, POSITION_TRIGGER_DATE, PLANNED_BASE_SALARY, PLANNED_SALARY, RESOURCE_UNIQUE_ID, CREATE_USER,
								CREATE_TIMESTAMP, UPDATE_USER, UPDATE_TIMESTAMP,AWARD_NUMBER, MODULE_CODE, SUB_MODULE_CODE, FREEZE_DATE, UPGRADE_TYPE_CODE, MULTIPLIER_USED,
								PREVIOUS_CHARGE_END_DATE, PREVIOUS_CHARGE_START_DATE, BASE_SALARY_USED, IS_REMAINING_CA_FROM_WBS, IS_RESOURCE_CREATED_OR_UPDATED
							...
							IF (LI_COUNT = 1) THEN
								...
								AND AWARD_MANPOWER_ID IN(SELECT AWARD_MANPOWER_ID FROM AWARD_MANPOWER
														WHERE AWARD_ID = LI_MASTER_AWARD_ID );
								SET LI_AWARD_MANPWR_NEXT_VAL = LI_UPD_AWARD_MANPOWER_ID;
							ELSE
							...
							IF (LI_RESOURCE_HAS_COUNT = 0) THEN
									...
									(
									 AWARD_MANPOWER_RESOURCE_ID, AWARD_MANPOWER_ID, PERSON_ID, ROLODEX_ID, POSITION_ID, FULL_NAME, POSITION_STATUS_CODE, COST_ALLOCATION,
									 ...
									 DESCRIPTION, POSITION_OWNED_BY_AWARD, CANDIDATE_TITLE_TYPE_CODE, POSITION_TRIGGER_DATE, PLANNED_BASE_SALARY, PLANNED_SALARY,
							...
							ELSE
									...
									COST_ALLOCATION = LI_COST_ALLOCATION,
									 ...
									 POSITION_OWNED_BY_AWARD = LS_POSITION_OWNED_BY_AWARD,
									 CANDIDATE_TITLE_TYPE_CODE = LS_CANDIDATE_TITLE_TYPE_CODE,
									 POSITION_TRIGGER_DATE = LS_POSITION_TRIGGER_DATE,
									 ...
									 UPGRADE_TYPE_CODE = LR_UPGRADE_TYPE_CODE,
