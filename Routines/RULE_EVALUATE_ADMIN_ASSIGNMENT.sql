DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `RULE_EVALUATE_ADMIN_ASSIGNMENT`(
        ...
        CURSOR_LOOP: LOOP
            ...
            WORKFLOW_CURSOR_LOOP: LOOP
                ...
                INTO LI_NODE, LI_NEXT_NODE, LI_NODE_IF_TRUE, LI_NODE_IF_FALSE,
                     LS_RULE_ID, LS_RULE_EXPRESSION, LS_MAP_ID;
                IF DONE1 THEN
            ...
            END IF;
        END LOOP;
        SELECT COUNT(*) INTO LS_COUNT FROM UNIT WHERE UNIT_NUMBER = LS_PARENT_UNIT_NUMBER;
        IF LS_COUNT = 0 THEN
