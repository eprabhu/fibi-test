DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `MIGRATE_PERSON_TRAINING`(AV_FEED_INFO_ID INT)
BEGIN
                                ...
                                CASE
                                    WHEN LI_CITI_DATA_STAGE_NUMBER = 1 THEN
                                        CASE
                                            ...
                                            WHEN UPPER(TRIM(substr(LS_GROUP,7))) = (substr('GCP Â¿ SOCIAL AND BEHAVIORAL RESEARCH BEST PRACTICES FOR CLINICAL RESEARCH',7)) THEN 100
                                    ...
                                    ELSE
                                        CASE
                                            ...
                                            WHEN UPPER(TRIM(substr(LS_GROUP,7))) = (substr('GCP Â¿ SOCIAL AND BEHAVIORAL RESEARCH BEST PRACTICES FOR CLINICAL RESEARCH',7)) THEN 101
