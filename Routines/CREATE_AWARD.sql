DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `CREATE_AWARD`(
  JSON_FORMAT JSON
)
BEGIN
...
BEGIN
				...
				BEGIN
					...
					VALUES(LI_AWARD_ID,LS_AWARD_NUMBER,LI_SEQUENCE_NUMBER,LS_ERROR_MSG,'CREATE_AWARD',NULL,NULL,null,UTC_TIMESTAMP(),'quickstart');
					COMMIT;
				END;
...
SELECT CONCAT(DATE_FORMAT(NOW(), '%y%m%d'), LPAD(DATE_FORMAT(NOW(), '%H%i%s%f') DIV 1000, 9, '0')) INTO LD_TRANSACTION_ID;
		INSERT INTO AWARD (
			...
			NULL, NULL, NULL, NULL,
			NULL, 'PENDING', UTC_TIMESTAMP(), 'quickstart', 'Y', NULL,
			UTC_TIMESTAMP(), 'quickstart', 1, NULL, 1,
			NULL, NULL, NULL, NULL, NULL, NULL,
			NULL, NULL, NULL, NULL, NULL, NULL,
			NULL, NULL, NULL, NULL, NULL, 'quickstart', UTC_TIMESTAMP()
		);
         ...
         INSERT INTO AWARD_PERSONS (
			 ...
			 UTC_TIMESTAMP(), 'quickstart', NULL, NULL,
        ...
        INSERT INTO AWARD_PERSON_UNIT (
			...
			LS_UNIT_NUMBER, 'Y', UTC_TIMESTAMP(), 'quickstart'
		);
		...
		INSERT INTO AWARD_AMOUNT_TRANSACTION (
            ...
            UPDATE_TIMESTAMP, UPDATE_USER, SOURCE_AWARD_NUMBER, DESTINATION_AWARD_NUMBER, TRANSACTION_STATUS_CODE
				...
				UTC_TIMESTAMP(), 'quickstart', 'EXTERNAL', LS_AWARD_NUMBER, 'P'
            );
		INSERT INTO AWARD_AMOUNT_INFO (
             ...
             LI_AWARD_ID, LS_AWARD_NUMBER ,1, LD_TRANSACTION_ID, UTC_TIMESTAMP(), 'quickstart', LD_ANTICIPATED_AMOUNT,
