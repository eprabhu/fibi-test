DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `GET_COI_DISCLOSURE_HISTORY`(
    ...
    SET ALL_DISC_JOIN_CONDITION= '';
        ...
        IF AV_FILTER_TYPE = 'ALL' THEN
    		...
    		SET ALL_DISC_JOIN_CONDITION = CONCAT(' FROM COI_DISCLOSURE T1
    		                            LEFT JOIN COI_DISCL_PROJECTS T11 ON T11.DISCLOSURE_ID = T1.DISCLOSURE_ID
    		                            LEFT JOIN COI_DISCLOSURE_FCOI_TYPE T2 ON T2.FCOI_TYPE_CODE = T1.FCOI_TYPE_CODE
