DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `CLOSE_SERVICE_REQUEST`(AV_RESOLVED_DAYS_THRESHOLD INT)
BEGIN
   ...
   DECLARE LS_QUERY VARCHAR(2000);
        ...
        UPDATE INBOX SET OPENED_FLAG = 'Y', UPDATE_TIMESTAMP = UTC_TIMESTAMP(), UPDATE_USER = 'System'
