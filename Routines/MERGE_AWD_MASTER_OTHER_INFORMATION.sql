DELIMITER $$
CREATE DEFINER=`fibi`@`%` PROCEDURE `MERGE_AWD_MASTER_OTHER_INFORMATION`(
...
DECLARE LS_DOCUMENT_UPDATE_TIMESTAMP	DATETIME;
		BEGIN
				...
				BEGIN
					...
					VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_MASTER_OTHER_INFORMATION',LS_TABLE_NAME,120,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
					COMMIT;
				END;
