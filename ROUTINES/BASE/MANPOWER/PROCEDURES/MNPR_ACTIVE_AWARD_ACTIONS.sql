CREATE PROCEDURE `MNPR_ACTIVE_AWARD_ACTIONS`(
    ...
    IF LI_MANPOWER_STAFF_SECTION_COUNT > 0 OR AV_DOCUMENT_TYPE = 1 THEN
        ...
        WORKDAY_REFERENCE_ID, ACTION_TYPE, UPDATE_USER, UPDATE_TIMESTAMP,COMMITTED_AMOUNT_USED)
        ...
        , COMMITTED_AMOUNT_USED FROM MANPOWER_WORKDAY_RESOURCE WHERE SUBSTRING_INDEX(WBS_NUMBER,'EOM',1) = AV_ACCOUNT_NUMBER AND ADJUSTED_COMMITTED_COST IS NOT NULL;
