...
DECLARE LS_QUESTIONNAIRE_COMPLETED_FLAG VARCHAR(3);
	...
	BEGIN 
			...
			END IF;
						...
						BEGIN
					        ...
					        SELECT QUESTIONNAIRE_COMPLETED_FLAG 
                            INTO LS_QUESTIONNAIRE_COMPLETED_FLAG 
                            FROM QUEST_ANSWER_HEADER 
                            WHERE QUESTIONNAIRE_ANS_HEADER_ID = LI_QUESTIONNAIRE_ANS_HEADER_ID;

                            IF LS_QUESTIONNAIRE_COMPLETED_FLAG = 'N' THEN
                             RETURN 'FALSE';
                            END IF;
