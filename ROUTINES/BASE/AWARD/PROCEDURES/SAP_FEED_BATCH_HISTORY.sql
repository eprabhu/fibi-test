CREATE PROCEDURE `SAP_FEED_BATCH_HISTORY`(
...
SET AV_CURRENT_PAGE = (20 * (AV_CURRENT_PAGE - 1));
	SELECT 
		T1.BATCH_ID,
	...
	GROUP BY T1.BATCH_ID ORDER BY T3.CREATE_TIMESTAMP DESC
    limit 20 offset AV_CURRENT_PAGE;
END
