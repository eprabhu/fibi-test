...
DECLARE  AWD_DATA CURSOR FOR
	...
	UNION
	SELECT OLD_AWARD_NUMBER FROM AWARD_EXPENSE_TEMP where OLD_AWARD_NUMBER IS NOT NULL and EXP_TRX_ID IS NOT NULL;
...
awd_lp: LOOP
   BEGIN 
		...
		BEGIN
			...
			VALUES(LI_SEQ_ERROR_LOG_ID,AV_FILE_ID,LS_ACCOUNT_NUMBER,LS_INTERNAL_ORDER_CODE,SUBSTR(CONCAT(LS_PROG_LOC,'-',LS_AWARD_NUMBER,'-',LS_ERROR_MSG),1,4000),'AWARD_EXPENSE_TRACKER_SYNC',UTC_TIMESTAMP(),'quickstart');
			COMMIT;
		END;
