CREATE PROCEDURE `MERGE_AWD_MASTER_DMP_QNR`(
...
DECLARE LS_DOCUMENT_UPDATE_TIMESTAMP	DATETIME;
	...
	BEGIN
			...
			BEGIN
				...
				VALUES(AV_AWARD_ID,AV_AWARD_NUMBER,AV_SEQUENCE_NUMBER,LS_ERROR_MSG,'MERGE_AWD_MASTER_DMP_QNR',LS_TABLE_NAME,126,AV_VARIATION_TYPE_CODE,UTC_TIMESTAMP(),AV_UPDATE_USER);
				COMMIT;
