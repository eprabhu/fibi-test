...
UNION
				...
				LEFT JOIN (
					...
					INNER JOIN (
						...
						WHERE S3.AWARD_NUMBER IN (SELECT AWARD_NUMBER FROM AWARD WHERE AWARD_ID =AV_SOURCE_MODULE_ID)
                        AND ((S2.TRANSACTION_STATUS_CODE IN ('P', 'A') AND S5.AWARD_DOCUMENT_TYPE_CODE = 1 
