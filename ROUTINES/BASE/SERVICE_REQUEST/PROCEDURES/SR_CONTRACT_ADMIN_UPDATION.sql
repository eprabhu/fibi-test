CREATE PROCEDURE `SR_CONTRACT_ADMIN_UPDATION`(AV_MODULE_KEY INT, AV_CHANGED_UNIT VARCHAR(20), AV_UPDATED_PERSON VARCHAR(200), UPDATE_TIME TIMESTAMP)
PROC:BEGIN
	...
	AND ua.UNIT_NUMBER = AV_CHANGED_UNIT;
    ...
    IF LI_SR_STATUS_CODE != 1 THEN
		...
		IF NOT (LS_PERSON_NAME <=> LS_PREV_PERSON_NAME) THEN
			...
			VALUES (8, LS_SR_REPORTER_ID, LS_SR_REPORTER_NAME, LI_SR_STATUS_CODE, UPDATE_TIME, AV_UPDATED_PERSON, AV_MODULE_KEY);
			...
			VALUES (LOG_ID, UPDATE_TIME, AV_UPDATED_PERSON, AV_MODULE_KEY, PRV_CUSTOM_DATA, UPD_CUSTOM_DATA);
        END IF;
    ...
    ELSE
        ...
        VALUES
        (LI_CUSTOM_ELEMENT_ID, 20, AV_MODULE_KEY, 0, 0, UPDATE_TIME, AV_UPDATED_PERSON, LS_PERSON_NAME, LS_PERSON_ID);
