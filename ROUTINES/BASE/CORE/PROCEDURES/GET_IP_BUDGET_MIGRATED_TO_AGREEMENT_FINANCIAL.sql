-- `GET_IP_BUDGET_MIGRATED_TO_AGREEMENT_FINANCIAL`; 

CREATE PROCEDURE `GET_IP_BUDGET_MIGRATED_TO_AGREEMENT_FINANCIAL`(
...
UNION
		 SELECT 
			...
			INNER JOIN PROPOSAL_STATUS T5 ON T5.STATUS_CODE = T1.STATUS_CODE
