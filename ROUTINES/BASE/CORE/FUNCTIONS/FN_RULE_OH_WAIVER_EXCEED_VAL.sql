...
SELECT IFNULL(RATE,0) into LI_RATE
 ...
 WHERE INSTITUTE_RATE_ID IN(SELECT MIN(INSTITUTE_RATE_ID)
                                         ...
                                         AND UNIT_NUMBER =(SELECT VALUE FROM PARAMETER WHERE PARAMETER_NAME = 'ROOT_UNIT'));
