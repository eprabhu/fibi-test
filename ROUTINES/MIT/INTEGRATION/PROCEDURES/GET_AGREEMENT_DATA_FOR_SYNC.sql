CREATE OR REPLACE PROCEDURE GET_AGREEMENT_DATA_FOR_SYNC (
...
BEGIN
    OPEN AV_RESULT_SET FOR
        ...
        WHERE A_G.UPDATE_TIMESTAMP BETWEEN AV_START_TIMESTAMP AND AV_END_TIMESTAMP
        ORDER BY A_G.AGREEMENT_REQUEST_ID ASC
