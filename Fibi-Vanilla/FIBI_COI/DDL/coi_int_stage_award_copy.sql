...
--
--  `coi_int_stage_award_copy`
--

DROP TABLE IF EXISTS `coi_int_stage_award_copy`;

CREATE TABLE `coi_int_stage_award_copy` (
  `STAGE_AWARD_ID` int(11) NOT NULL AUTO_INCREMENT,
