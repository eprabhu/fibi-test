-- `GET_PROGRESS_REPORT_DASHBOARD_COUNT`; 
...
END IF;
     SET LS_DYN_SQL = CONCAT('WITH ACCESS_TMP 
							...
							AND RIGHT_NAME IN (''VIEW_PROGRESS_REPORT'',''MODIFY_PROGRESS_REPORT'') 							
							UNION
							...
							SELECT DISTINCT S1.AWARD_ID FROM AWARD_PERSON_ROLES S1
											...
											INNER JOIN RIGHTS R3 ON R3.RIGHT_ID = R2.RIGHT_ID AND R3.RIGHT_NAME IN (''VIEW_PROGRESS_REPORT'',''MODIFY_PROGRESS_REPORT'') WHERE S1.PERSON_ID=''',AV_PERSON_ID,''' ),
