...
ELSEIF AV_MODULE_CODE = 1 THEN
                ...
                ELSE
                        ...
                        END IF;
						 ...
						 SELECT COUNT(1) INTO LI_COUNT  FROM  PERSON_ROLES PR JOIN
										...
										WHERE RR.RIGHT_ID = RT.RIGHT_ID AND RT.RIGHT_NAME IN ('MODIFY_AWARD','VIEW_AWARD')) RLE ON RLE.ROLE_ID = PR.ROLE_ID
        ...
        AND S2.AWARD_SEQUENCE_STATUS='PENDING';
         ...
         SELECT  COUNT(1) INTO LI_COUNT
					...
					WHERE PR.PERSON_ID = AV_LOGGED_IN_PERSON_ID
					AND (( PR. DESCEND_FLAG = 'Y' AND  EXISTS (SELECT 1
                                        FROM UNIT_WITH_CHILDREN WHERE CHILD_UNIT_NUMBER = LS_LEAD_UNIT))OR ( PR. DESCEND_FLAG = 'N' AND PR.UNIT_NUMBER = LS_LEAD_UNIT ))
					;
