-- `MIGRATE_IP_SPONSOR_TO_AGREEMENT`; 

CREATE PROCEDURE `MIGRATE_IP_SPONSOR_TO_AGREEMENT`(
...
BEGIN
    ...
    IF V_COUNT = 0 THEN
        ...
        SELECT
            ...
            AV_UPDATED_USER
            FROM sponsor T1
            INNER JOIN proposal T2 ON T1.SPONSOR_CODE = T2.SPONSOR_CODE WHERE
    ...
    INSERT INTO AGREEMENT_SPONSOR (
        ...
        SELECT
            ...
            AV_UPDATED_USER
            FROM sponsor T1
            INNER JOIN proposal T2 ON T1.SPONSOR_CODE = T2.PRIME_SPONSOR_CODE WHERE
            T2.PROPOSAL_ID = AV_SOURCE_MODULE_ID
        ;
END
