...
select
   ...
   `t20`.`VALUE` AS `GRANT_CODE`,
   `t11`.`VALUE` AS `INPUT_GST_CATEGORY`,
   `t12`.`VALUE` AS `OUTPUT_GST_CATEGORY`,
   `t13`.`VALUE` AS `RIE_Domain`,
   `t14`.`VALUE` AS `COST_CENTER`,
   `t16`.`VALUE` AS `FUND_CENTER` 
from
   (
((((((((((((((`award` `t1` 
      join
      ...
      left join
         `custom_data` `t20` 
         on(((`t1`.`AWARD_ID` = `t20`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t20`.`CUSTOM_DATA_ELEMENTS_ID` = 3
         )
))) 
      left join
         `custom_data` `t11` 
         on(((`t1`.`AWARD_ID` = `t11`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t11`.`CUSTOM_DATA_ELEMENTS_ID` = 
            (
               select
      ...
      left join
         `custom_data` `t12` 
         on(((`t1`.`AWARD_ID` = `t12`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t12`.`CUSTOM_DATA_ELEMENTS_ID` = 
            (
               select
                  `custom_data_elements`.`CUSTOM_DATA_ELEMENTS_ID` 
               from
      ...
      left join
         `custom_data` `t13` 
         on(((`t1`.`AWARD_ID` = `t13`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t13`.`CUSTOM_DATA_ELEMENTS_ID` = 
            (
               select
                  `custom_data_elements`.`CUSTOM_DATA_ELEMENTS_ID` 
               from
               ...
               where
                  (
                     `custom_data_elements`.`custom_element_name` = 'Sub-Lead Unit'
                  )
            )
         )
))) 
      left join
         `custom_data` `t14` 
         on(((`t1`.`AWARD_ID` = `t14`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t14`.`CUSTOM_DATA_ELEMENTS_ID` = 
            (
               select
                  `custom_data_elements`.`CUSTOM_DATA_ELEMENTS_ID` 
               from
               ...
               where
                  (
                     `custom_data_elements`.`custom_element_name` = 'Legacy WBS Number'
                  )
            )
         )
))) 
      left join
         `custom_data` `t16` 
         on(((`t1`.`AWARD_ID` = `t16`.`MODULE_ITEM_KEY`) 
         and 
         (
            `t16`.`CUSTOM_DATA_ELEMENTS_ID` = 
            (
               select
                  `custom_data_elements`.`CUSTOM_DATA_ELEMENTS_ID` 
               from
