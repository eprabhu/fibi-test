-- `FN_CLOSURE_VALIDATION_SUBMISSION`; 


CREATE FUNCTION `FN_CLOSURE_VALIDATION_SUBMISSION`( 
...
SELECT COUNT(*)
 INTO LI_PROGRESS_COUNT FROM  AWARD_PROGRESS_REPORT 
    WHERE AWARD_ID = LS_AWARD_ID AND REPORT_CLASS_CODE = 1 AND PROGRESS_REPORT_STATUS_CODE = 4;
END IF;
