-- `FN_VAL_FINANCE_ACC_TASK`; 


CREATE FUNCTION `FN_VAL_FINANCE_ACC_TASK`(AV_AWARD_ID  VARCHAR(22)
) RETURNS varchar(10) 
    DETERMINISTIC
BEGIN
	DECLARE LI_TASK_7_COUNT INT;
