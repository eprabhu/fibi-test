DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `COPY_MERGE_EPS_PROPOSAL_CUSTOM_DATA`(
...
BEGIN
   ...
   UPDATE_USER, VALUE, COLUMN_ID, COLUMN_VERSION_NUMBER, DESCRIPTION
...
SET SQL_SAFE_UPDATES = 1;
   ...
   SET LS_PROC_LOC = 'CUSTOM_DATA';
         OPEN SEL_CUSTOM_DATA;
            ...
            SET NOT_FOUND  = 0;
            FETCH SEL_CUSTOM_DATA INTO LI_CUSTOM_DATA_ELEMENTS_ID,LD_UPDATE_TIMESTAMP,LS_UPDATE_USER,LS_VALUE,LI_COLUMN_ID,LI_COLUMN_VERSION_NUMBER,LS_DESCRIPTION;
            IF NOT_FOUND=1 THEN
