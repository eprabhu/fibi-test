DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `PR_MASTER_DATASET_SYNC`()
BEGIN
...
BEGIN
	...
	SET AUTOCOMMIT = 0;
	SET LS_ERR_FLG = 'N';
SELECT PR_LAST_SYNC_TIMESTAMP INTO LS_LAST_SYNC_TIMESTAMP FROM REPORT_LAST_SYNC_TIME;
