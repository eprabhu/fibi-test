DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SAP_FEED_REINTERFACE_FEED_DATA`(
AV_PREV_FEED_ID		INT,
...
BEGIN
			...
			END;
			COMMIT;
			UPDATE SAP_AWARD_FEED SET FEED_STATUS = 'F',UPDATE_USER = 'quickstart' ,UPDATE_TIMESTAMP = UTC_TIMESTAMP()
