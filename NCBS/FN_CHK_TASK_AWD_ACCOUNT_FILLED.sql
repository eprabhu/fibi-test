DELIMITER $$
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_CHK_TASK_AWD_ACCOUNT_FILLED`(AV_TASK_ID VARCHAR(10),
AV_TASK_TYPE_CODE varchar(3) ) RETURNS varchar(6) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
