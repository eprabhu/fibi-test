DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_ALL_RIGHTS_FOR_A_MODULE_BKP`(
...
WHERE PR.PERSON_ID = AV_PERSON_ID
AND RT.RIGHT_NAME IN (
    'CREATE_PROPOSAL', 'MODIFY_PROPOSAL', 'DELETE_PROPOSAL', 'SUBMIT_PROPOSAL',
    'MAINTAIN_PROPOSAL_BUDGET', 'VIEW_PROPOSAL', 'WITHDRAW_PROPOSAL', 'VIEW_PROPOSAL_ATTACHMENTS',
    'MODIFY_PROPOSAL_ATTACHEMNTS', 'ASSIGN_REVIEW', 'ENDORSE_PROPOSAL', 'MAINTAIN_RANK',
    'DEFINE_APPROVED_BUDGET', 'MAINTAIN_PRIVATE_COMMENTS', 'WRITE_REVIEW',
    'VIEW_REVIEW_COMPLETED_TAB', 'VIEW_REVIEW_IN_PROGRESS_TAB', 'BYPASS_APPROVER',
    'ALTER_PROPOSAL_DATA', 'MAINTAIN_PROPOSAL_ACCESS', 'APPROVE_PROPOSAL_EVALUATION',
    'VIEW_ANY_PROPOSAL', 'MAINTAIN_APPLICATIONS', 'SHORTLIST_APPLICATIONS', 'DEACTIVATE_PROPOSAL',
    'MAINTAIN_EVALUATION_FORM', 'BYPASS_WORKFLOW', 'VIEW_EVALUATION_ROUTE_LOG',
    'MODIFY_DOCUMENT_PERMISSION', 'START_EVALUATION', 'ADD_APPROVER_WORKFLOW', 'PD_ADMIN_CORRECTION',
    'CREATE_INST_PROPOSAL', 'MODIFY_PROPOSAL_ATTACHMENTS_IN_WORKFLOW',
    'PROXY_PROPOSAL_PERSON_CERTIFICATION', 'CREATE_EXT_REVIEW', 'VIEW_EXT_REVIEW',
    'MODIFY_EXT_REVIEW', 'MODIFY_PROPOSAL_QUESTIONNAIRE', 'VIEW_CONFIDENTIAL_PROPOSAL_ATTACHMENTS'
)
AND (
    (PR.DESCEND_FLAG = 'Y' AND AV_LEAD_UNIT = UC.CHILD_UNIT_NUMBER)
    OR (PR.DESCEND_FLAG = 'N' AND PR.UNIT_NUMBER = AV_LEAD_UNIT)
)
UNION
    SELECT T3.RIGHT_NAME
