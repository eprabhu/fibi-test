DELIMITER $$
CREATE DEFINER=`ku_rms_user`@`%` FUNCTION `FN_CHECK_SDC_GM`(
...
DECLARE LS_GRANT_CALL_LEAD_UNIT VARCHAR(50);
DECLARE LS_AWARD_LEAD_UNIT			VARCHAR(50);
...
END IF;
	...
	IF LS_AWARD_LEAD_UNIT IS NOT NULL THEN
