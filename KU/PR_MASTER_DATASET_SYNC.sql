...
DELETE FROM PROG_RPT_KPI_RT WHERE PROGRESS_REPORT_NUMBER IN (SELECT DISTINCT PROGRESS_REPORT_NUMBER FROM TEMP_PR_MASTER_DATASET_RT);
DELETE FROM PROG_RPT_MILESTONES_RT WHERE PROGRESS_REPORT_NUMBER IN (SELECT DISTINCT PROGRESS_REPORT_NUMBER FROM TEMP_PR_MASTER_DATASET_RT);
