...
SELECT TRIM(TRAILING 'AND ' FROM LS_FILTER_CONDITION) INTO LS_FILTER_CONDITION FROM DUAL;
  ELSE
    ...
    SET ls_dyn_sql =CONCAT(ls_dyn_sql,'
									...
									LEFT JOIN SPONSORS SPO ON T1.AGREEMENT_REQUEST_ID = SPO.AGREEMENT_REQUEST_ID ', JOIN_CONDITION, LS_ADMIN_GROUP_CONDITION,LS_TAB_QUERY,LS_FILTER_CONDITION_NEW,LS_FILTER_CONDITION,')T ',LS_SORT_TYPE,LS_OFFSET_CONDITION);
