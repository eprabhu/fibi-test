DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `DELETE_AWARD_BY_ID`(AV_AWARD_ID INT)
BEGIN
...
DECLARE LS_ERROR_MSG	        VARCHAR(1000);
					...
					VALUES(LI_AWARD_ID,LS_AWARD_NUMBER,0,LS_ERROR_MSG,'DELETE_AWARD_BY_ID',NULL,NULL,null,UTC_TIMESTAMP(),'quickstart');
					COMMIT;
				    END;
				BEGIN
