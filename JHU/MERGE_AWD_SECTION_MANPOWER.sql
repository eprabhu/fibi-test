DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `MERGE_AWD_SECTION_MANPOWER`(
AV_AWARD_ID             INT,
                        ...
                        SET LS_TABLE_NAME = 'AWARD_MANPOWER_RESOURCE';
                         BEGIN
                            ...
                            SELECT
                                ...
                                PREVIOUS_CHARGE_END_DATE, PREVIOUS_CHARGE_START_DATE, BASE_SALARY_USED, IS_REMAINING_CA_FROM_WBS, IS_RESOURCE_CREATED_OR_UPDATED,IS_MULTI_ACCOUNT,IS_MAIN_ACCOUNT
