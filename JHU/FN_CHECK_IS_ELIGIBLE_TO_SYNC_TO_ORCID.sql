DELIMITER $$
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_CHECK_IS_ELIGIBLE_TO_SYNC_TO_ORCID`(AV_AWARD_ID INT, AV_DOCUMENT_TYPE_CODE VARCHAR(2),
    AV_SERVICE_TYPE_CODE VARCHAR(2)) RETURNS varchar(5) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
