DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `AWARD_REVENUE_TRACKER_SYNC`(
AV_FILE_ID INT)
BEGIN
...
BEGIN
		...
		BEGIN
			...
			VALUES(LS_ACCOUNT_NUMBER,LS_INTERNAL_ORDER_CODE,LS_ERROR_MSG,'AWARD_REVENUE_TRACKER_SYNC',utc_timestamp(),'quickstart');
		END;
