					...
					DECLARE CUR_BIZ_RULE CURSOR FOR
						...
						CUR_BIZ_RULE_LOOP : LOOP
									...
									INSERT INTO business_rules(RULE_ID,DESCRIPTION,RULE_TYPE,UNIT_NUMBER,MODULE_CODE,SUB_MODULE_CODE,IS_ACTIVE,
											...
											RULE_CATEGORY)
									VALUE(LI_SEQ_RULE_ID,LL_DESCRIPTION,LL_RULE_TYPE,LL_UNIT_NUMBER,LL_MODULE_CODE,LL_SUB_MODULE_CODE,LL_IS_ACTIVE, LL_RULE_EXPRESSION,now(),'quickstart',LL_NOTIFICATION_ID,LL_USER_MESSAGE,LL_RULE_EVALUATION_ORDER, LL_MAP_ID,LL_RULE_CATEGORY);
									BEGIN
											...
											DECLARE CONTINUE HANDLER FOR NOT FOUND SET DONE2 = TRUE;
												...
												VALUE(LI_SEQ_RULE_EXP_ID,LL_RULE_ID,LL_EXPRESSION_NUMBER,LL_EXPRESSION_TYPE_CODE,LL_LVALUE,LL_CONDITION_OPERATOR,LL_RVALUE,now(),'quickstart',LL_PARENT_EXPRESSION_NUMBER);
												COMMIT;
											END LOOP;
