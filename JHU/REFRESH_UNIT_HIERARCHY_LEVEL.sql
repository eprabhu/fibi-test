DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `REFRESH_UNIT_HIERARCHY_LEVEL`()
    DETERMINISTIC
BEGIN
...
SET LS_CHILD_LIST = '';
    REPEAT
	  ...
	  INSERT INTO UNIT_LEVEL(UNIT_NUMBER,UNIT_NAME,PARENT_UNIT_NUMBER,ACTIVE_FLAG,LVL)
	  SELECT UNIT_NUMBER,UNIT_NAME,PARENT_UNIT_NUMBER,ACTIVE_FLAG, 1 AS LVL
