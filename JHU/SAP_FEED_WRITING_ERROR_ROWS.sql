DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `SAP_FEED_WRITING_ERROR_ROWS`(
AV_PREV_FEED_ID 	INT,
...
BEGIN
	...
	BEGIN
		...
		VALUES(LI_SEQ_ERROR_LOG_ID,CONCAT('IN SAP_FEED_WRITING_ERROR_ROWS PROCEDURE ',SUBSTR(LS_ERROR_MSG,1,960)),NOW(),'quickstart');
	END;
