...
,av_appointment_unit_number_in VARCHAR(8)
...
DECLARE ls_home_unit VARCHAR(8)  DEFAULT  '000001';
DECLARE ld_interface_timestamp DATE  DEFAULT  NULL;
...
SET SQL_SAFE_UPDATES =0;
    ...
    IF av_appointment_unit_number_in IS NOT NULL THEN
	    ...
	    ELSEIF av_ssn_in IS NOT NULL THEN
