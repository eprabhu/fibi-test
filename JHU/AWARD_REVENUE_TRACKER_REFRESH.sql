DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `AWARD_REVENUE_TRACKER_REFRESH`(
AV_FILE_ID INT)
BEGIN
...
BEGIN
        ...
        BEGIN
                ...
                VALUES(LS_ACCOUNT_NUMBER,LS_INTERNAL_ORDER_CODE,LS_ERROR_MSG,'AWARD_REVENUE_TRACKER_REFRESH',UTC_TIMESTAMP(),'quickstart');
                SET LI_ERROR_FLAG = 1;
        END;
        SET LI_ERROR_FLAG = 0;
        BEGIN
