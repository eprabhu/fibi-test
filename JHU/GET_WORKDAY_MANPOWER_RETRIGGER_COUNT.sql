DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_WORKDAY_MANPOWER_RETRIGGER_COUNT`(
...
SELECT DISTINCT T1.AWARD_NUMBER, T4.TITLE, T1.INTERFACE_TYPE_CODE, T3.DESCRIPTION AS INTERFACE_TYPE, T1.INTERFACE_STATUS_CODE, T5.DESCRIPTION AS INTERFACE_STATUS, T1.INTERFACE_TIMESTAMP, T2.MESSAGE, T2.MESSAGE_TYPE, T1.MANPOWER_USER_ACTION_CODE
