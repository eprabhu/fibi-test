DELIMITER $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `COPY_MERGE_EPS_PROPOSAL_ADDITIONAL_DATA`(
...
BEGIN
	...
	DECLARE LS_PROJECT_TITLE	varchar(255);
	...
	SELECT   RESEARCH_AREA_CODE, RESRCH_TYPE_CODE, UPDATE_TIMESTAMP,
...
SET LS_PROC_LOC = 'EPS_PROPOSAL_RESRCH_AREAS';
			...
			SET NOT_FOUND  = 0;
            FETCH SEL_EPS_PROPOSAL_RESRCH_AREAS INTO LS_RESEARCH_AREA_CODE,LS_RESRCH_TYPE_CODE,LD_UPDATE_TIMESTAMP,LS_UPDATE_USER,LS_RESRCH_TYPE_AREA_CODE,LS_RESRCH_TYPE_SUB_AREA_CODE,LS_RESEARCH_SUB_AREA_CODE,LS_CHALLENGE_AREA_CODE,LS_CHALLENGE_SUBAREA_CODE,LI_RESEARCH_RANK;
            IF NOT_FOUND=1 THEN
