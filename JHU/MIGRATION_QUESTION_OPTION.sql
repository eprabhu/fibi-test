DELIMITER $$
CREATE  PROCEDURE `MIGRATION_QUESTION_OPTION`(LI_QUESTIONNAIRE_ID INt,LI_QUESTIONNAIRE_VERSION_NUMBER INT, LI_MIGRATED_QUESTIONNAIRE_ID INT,	AV_QUESTION_NUMBER INT)
BEGIN
