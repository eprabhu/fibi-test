...
SET SELECTED_HINDEX_VALUE = '';
    ...
    'SELECT COUNT(1) FROM (SELECT DISTINCT  T1.*, GROUP_CONCAT(T6.DESCRIPTION SEPARATOR ", ") AS SPECIALISM_KEYWORD, T3.DESCRIPTION AS REVIEWER_AFFILIATION ',SELECTED_FIELD_LIST, ' FROM EXTERNAL_REVIEWER T1
    ...
    ',LS_FILTER_CONDITION,' GROUP BY T1.EXTERNAL_REVIEWER_ID)T ',AV_SORT_TYPE
);
